...
export default class StartEnd extends Component {
  ...
  startElection = async () => {
    await this.state.ElectionInstance.methods
      .startElection()
      .send({ from: this.state.account, gas: 1000000 , gasPrice:1000000000});
    window.location.reload();
  };
  endElection = async () => {
    await this.state.ElectionInstance.methods
    ...
    if (!this.state.web3) {
      return (
        <>
          ...
          <center>Please Connect Your Metamask/Voting account</center>
        </>
      );
    }
        ...
        <div className="container-main">
          ...
          {!this.state.elStarted ? (
            ...
            <>
              ...
              <div className="container-item">
                <button onClick={this.endElection} className="abc">
                  End
                </button>
              </div>
            </>
